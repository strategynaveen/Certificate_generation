        ...
        <div class="row">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light  bg-primary" style="background-color: #e3f2fd;">
                    ...
                    <a class="navbar-brand text-white h1 hd font-weight-bold  " href="#">Customized Template</a>

                    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li class="nav-item">
                            <a class="nav-link text-white "   href="<?php echo site_url('home/new_certificate'); ?>">New Certificate<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white"   href="<?php echo site_url('home/identity_certificate'); ?>">Identity</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="<?php echo site_url('home/gcertificate'); ?>">Generate Certificate</a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link text-white "  href="<?php echo site_url('home/my_certificate'); ?>">My Certificate</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white nava" href="<?php echo site_url('home/upload_data'); ?>">Upload Student</a>
                        </li>
